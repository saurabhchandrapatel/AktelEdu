...
class Admin_Form_Admin extends Zend_Form {
    ...
    private function decorator(){
                ...
                $this->UserInput = new Admin_Form_Decorator_DeInput();
		        $this->Button = New Admin_Form_Decorator_DeButton();
		        $this->UserButton = New Admin_Form_Decorator_DeButton();
		        $this->ButtonLeft = New Admin_Form_Decorator_DeButtonLeft();
		        $this->Password= New Admin_Form_Decorator_DePassword();

		       $this->REInput= New Admin_Form_Decorator_ReInput();
		       $this->REButton= New Admin_Form_Decorator_ReButton(); 
		       $this->RESETButton= New Admin_Form_Decorator_ResetButton();
