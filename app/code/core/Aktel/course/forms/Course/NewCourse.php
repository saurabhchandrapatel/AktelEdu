...
#Zend_Loader::loadClass('System_Form_Decorator_DeInput');


class Course_Form_Course_NewCourse extends Zend_Form {
    ...
    private function decorator(){
  	            ...
  	            $this->Input = new Course_Form_Decorator_DeInput();  
		        $this->Button = New Course_Form_Decorator_DeButton();
		        $this->Password= New Course_Form_Decorator_DePassword();
		        $this->Text= New Course_Form_Decorator_DeText();
 				$this->Select= New Course_Form_Decorator_ReSelect(); 
