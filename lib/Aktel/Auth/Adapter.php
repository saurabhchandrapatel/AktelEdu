...
/* Aktel_Auth_Exception */

/* Aktel Auth_Adapter_Exception */
 ...
 * @license     http://www.gnu.org/copyleft/gpl.html     GNU General Public License
 */ 
abstract class  Aktel_Auth_Adapter 
{ 
    /**
     ...
     *
     * @throws Aktel_Auth_Adapter_Exception
     * @return Aktel_Auth_Token_Interface
     */ 
    public function authenticate() 
    { 
        throw new Aktel_Auth_Adapter_Exception('authenticate() must be implemented by a concrete adapter class'); 
    } 
}